    ...
    return (
        <div style={{ display: 'flex', background: '#fff6e0', minHeight: '100vh', padding: '20px' }}>
            <div style={{ width: '200px', marginRight: '20px' }}>
                ...
                <ToggleMenu title="🏠 Habitación" open={showMenus.habitacion} toggle={() => setShowMenus({ ...showMenus, habitacion: !showMenus.habitacion })}>
                    ...
                    {decoraciones.pared && (
                        <>
                            <MenuButton
                                onClick={() => togglePoster('hellokittyemo')}
                                label={`${postersActivos.hellokittyemo ? '✅' : '⬜'} Hello Kitty Emo`}
                            />
                            <MenuButton
                                onClick={() => togglePoster('hellokittyprincesa')}
                                label={`${postersActivos.hellokittyprincesa ? '✅' : '⬜'} Hello Kitty Princesa`}
                            />
                            <MenuButton
                                onClick={() => togglePoster('hellokittyladron')}
                                label={`${postersActivos.hellokittyladron ? '✅' : '⬜'} Hello Kitty Ladrón`}
                            />
                        </>
                    )}
                </ToggleMenu>
            ...
            <div style={{ flex: 1, textAlign: 'center', position: 'relative', background: '#fff', borderRadius: '20px', padding: '20px', overflow: 'hidden' }} onClick={onDrop}>
                {decoraciones.pared && (
                    <>
                        ...
                        {postersActivos.hellokittyprincesa && (
                            <img
                                src="/hellokittyprincesa.png"
                                alt="Hello Kitty Princesa"
                                style={{
                                    position: 'absolute',
                                    top: '12%',
                                    left: '50%',
                        ...
                        {postersActivos.hellokittyladron && (
                            <img
                                src="/hellokittyladron.png"
                                alt="Hello Kitty Ladrón"
                                style={{
                                    position: 'absolute',
                                    top: '12%',
                                    left: '80%',
                ...
                <img src="/nevera.png" alt="Nevera" style={{ position: 'absolute', bottom: '10%', left: '5%', width: '220px', height: '320px', zIndex: 4 }} />
                ...
                <div style={{ position: 'relative', display: 'inline-block', zIndex: 5 }}>
                    <img src="/sota.png" alt="Sota el gatito" style={{ width: '800px', maxWidth: '100%', borderRadius: '50%', cursor: 'pointer' }} onClick={acariciar} />
                    {renderAccesorios()}
                </div>
                <div>
